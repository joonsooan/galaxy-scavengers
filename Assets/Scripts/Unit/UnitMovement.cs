...
public class UnitMovement : MonoBehaviour
{
    ...
    private static readonly PriorityQueue<Node> OpenQueue = new PriorityQueue<Node>(1000);
    private static readonly HashSet<Vector3Int> ClosedList = new HashSet<Vector3Int>();
    ...
    private Queue<Vector3> FindPath(Vector3 startPos, Vector3 endPos)
    {
        ...
        while (OpenQueue.Count > 0 && iterations < maxIterations) {
            ...
            if (ClosedList.Contains(currentNode.position)) continue;
            ...
            foreach (Vector3Int offset in NeighborOffsets) {
                ...
                if (!IsCellWalkable(neighborPos)) continue;
