...
public class FogOfWarVisibilityCalculator
{
    ...
    public FogOfWarVisibilityCalculator(Grid grid, Dictionary<IVisionProvider, HashSet<Vector3Int>> providerAffectedTiles, 
    ...
    public Dictionary<Vector3Int, FogOfWarState> CalculateVisibilityStates(HashSet<Vector3Int> tilesToCheck, 
    ...
    private HashSet<Vector3Int> CalculateAffectedTiles(Vector3Int centerCell, Vector3 worldPos, float visionRange, int rangeInCells)
    {
