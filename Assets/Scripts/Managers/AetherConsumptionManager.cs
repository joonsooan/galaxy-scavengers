...
{
    private readonly List<IAetherConsumer> _aetherConsumers = new List<IAetherConsumer>();
    private readonly List<ResourceGenerator> _aetherGenerators = new List<ResourceGenerator>();
    private readonly List<Battery> _batteries = new List<Battery>();
    private readonly Dictionary<IAetherConsumer, bool> _consumerStates = new Dictionary<IAetherConsumer, bool>();
    ...
    public float NetAetherPerSecond {
        get {
            return AetherProductionPerSecond - TotalAetherConsumptionPerSecond;
        }
    }
