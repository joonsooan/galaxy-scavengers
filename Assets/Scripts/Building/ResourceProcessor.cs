...
public class ResourceProcessor : Damageable
{
    ...
    private List<ProcessingRecipe> _recipes;
    ...
    private ProcessingRecipe _activeRecipe;
    ...
    private bool HasIngredientsFor(ProcessingRecipe recipe)
    {
        foreach (var ingredient in recipe.ingredients)
        {
    ...
    private void ConsumeIngredients(ProcessingRecipe recipe)
    {
        foreach (var ingredient in recipe.ingredients)
        {
